...
Die zentrale Amplitude der MMNm konnte bei $208\,ms$ registriert werden. Bei beiden Versuchspersonen kam es zu einer rechtsseitigen Lateralität. In der topografischen Darstellung der Sensoren in den Abbildungen~\ref{img:topolot} wird die bevorzugte rechtsseitige Aktivität im Intervall $(203,\,212)\,ms$ deutlich.
...
In den Zeitverläufen werden zwei Ergebnisse deutlich. Zum einen weist Minimum Norm Estimate im Zeitverlauf keine MMNm-Amplitude auf. Zwar ist die Aktivität wie oben beschrieben genauer, der Zeitverlauf weist jedoch nicht das Verhalten auf, was im Gyrus temporalis superior für eine MMNm zu erwarten wäre. Die Nebenhypothese kann an dieser Stelle also teilweise bestätigt werden. Minimum Norm Estimate zeigt keine gute Lösung unter Verwendung von Rohdaten. Zum anderen kann Beamformer einen typischen Zeitverlauf auch unter Verwendung von rauschunterdrückten Daten nicht errechnen. 
