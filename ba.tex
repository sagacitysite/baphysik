...
% Eventuell folgenden Abschnitt (Vorteile/Nachteile) raus nehmen?? Wirkt redunant
%Vorteil des Beamformer-Verfahrens liegt vor allem darin, dass keine a priori Annahme über die Quellkonfiguration erfolgt. Eine wichtige Limitierung liegt vor allem darin, dass Korrelationen zwischen den Quellorten zu einer Verschmelzung der Quellen führt, die einzelnen Orte können nicht mehr unterschieden werden \parencite{van1997localization}.
