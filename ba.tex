...
\begin{equation}
\label{sec:leadfield-error-sum}
y_i = \left( \sum_{j=1}^n S_j \cdot L_j \right) + R
\end{equation}
...
Bei den \emph{verteilten Dipolmodellen} werden sehr viele Quellen betrachtet, deutlich mehr als Sensoren verfügbar sind. Damit ergeben sich unendlich viele exakte Lösungen. Um physikalisch sinnvolle Lösungen zu finden müssen Nebenbedingungen aufgestellt werden. Übliche Nebenbedingungen sind:
