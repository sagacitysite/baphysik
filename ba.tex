...
%%% Hier nochmal nachbessern !!! siehe Anmerlung von Burkhard
% Nochmal im Buch (Link) nachschauen
...
\begin{figure}
  ...
  \begin{subfigure}[c]{0.47\textwidth}
    ...
    \subcaption{Minimum Norm Estimate, linke Hemisphäre}
...
%  \centering
  ...
  \captionsetup{justification=justified}
  \vspace*{3mm}
  \caption[Quellaktivität von Versuchsperson \texttt{pa07} in allen Bedingungen]{Quellaktivität von Versuchsperson \texttt{pa07} in allen Bedingungen in der rechten Hemisphäre bei $208\,ms$ zum Zeitpunkt des Auftretens der MMNm.}
